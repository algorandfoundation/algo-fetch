...
Generated KmdClient for Algorand based on the [OpenAPI Specification](https://raw.githubusercontent.com/algorand/go-algorand/v3.18.1-stable/daemon/kmd/api/swagger.json). 
