...
Generated AlgodClient for Algorand based on the [OpenAPI Specification](https://raw.githubusercontent.com/algorand/go-algorand/v3.22.1-stable/daemon/algod/api/algod.oas3.yml). 
