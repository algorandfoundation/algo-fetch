...
Generated AlgodClient for Algorand based on the [OpenAPI Specification](https://raw.githubusercontent.com/algorand/go-algorand/v3.16.3-stable/daemon/algod/api/algod.oas3.yml). 
...
- API: Disable body limit middleware for admin endpoints. ([#5486](https://github.com/algorand/go-algorand/pull/5486))
